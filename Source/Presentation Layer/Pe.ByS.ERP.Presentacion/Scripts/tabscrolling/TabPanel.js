...
TabPanel.prototype = {
    ...
    init: function () {
        ...
        var heightContenedorPanel = $(window).height() - 108;
        this.tabpanel_content.height(heightContenedorPanel - this.tabpanel_tab_content.get(0).offsetHeight);
    ...
    */
    kill: function (position) {
        ...
        EliminarDialogListByTabItem(this.tabs[position].id);
