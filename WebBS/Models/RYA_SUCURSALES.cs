...
namespace WebBS.Models
{
    ...
    public partial class RYA_SUCURSALES
    {
        public RYA_SUCURSALES()
        {
            this.RYA_MOVALM_CAB = new HashSet<RYA_MOVALM_CAB>();
            this.RYA_PEDIDO_CAB = new HashSet<RYA_PEDIDO_CAB>();
        }
        ...
        public virtual ICollection<RYA_PEDIDO_CAB> RYA_PEDIDO_CAB { get; set; }
    }
}
